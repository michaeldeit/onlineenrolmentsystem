 ...
 School Location
           ...
           <script type="text/javascript">
            ...
            <div class="col-md-4">
                ...
                <p>
                    Urduja College University
                <br>Quezon City Campus located at #1071 Brgy. Kaligayahan, Quirino Highway, Novaliches, Quezon City, and the Bulacan Campus located at IPO Road, Barangay Minuyan Proper, City of San Jose Del Monte, Bulacan. <br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: 09643525471</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">Email</abbr>: <a href="mailto:name@example.com"></AdmissionUrdujaCollge.com></>
                </p>
